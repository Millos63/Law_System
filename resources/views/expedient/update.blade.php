...
<!--FORMULARIO PARA CLIENTES-->
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_client" class="form-control @error('id_client') is-invalid @enderror"  value="{{ old('id_client', $expedient?->id_client)}}"  id="id_client" placeholder="Id Client" readonly>
...
<script>
    document.addEventListener('DOMContentLoaded', function(){
        ...
        //Tenemos que asegurarnos de adjuntar el evento onchange al seleccionar el elemento
